...
# CHECK-NEXT:         %7 = linalg.fill {__xtc_id_matmul_0_} ins(%cst : f32) outs(%extracted_slice_3 : tensor<1x1xf32>) -> tensor<1x1xf32>
...
# CHECK-NEXT:         linalg.fill {__xtc_id_matmul_0_} ins(%cst_0 : f32) outs(%subview_2 : memref<1x1xf32, strided<[32, 1], offset: ?>>)
...
# CHECK-NEXT:         memref.copy %5, %subview_4 : memref<2x32xf32, strided<[32, 1], offset: ?>> to memref<2x32xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:         %4 = arith.maximumf %in, %in_3 : f32
