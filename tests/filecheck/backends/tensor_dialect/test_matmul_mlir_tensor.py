...
# CHECK-NEXT:            %6 = scf.for %arg9 = %c0 to %c2 step %c1 iter_args(%arg10 = %extracted_slice_4) -> (tensor<2x16xf32>) {
# CHECK-NEXT:              %extracted_slice_6 = tensor.extract_slice %extracted_slice_1[%arg9, 0] [1, 1] [1, 1] : tensor<2x1xf32> to tensor<1x1xf32>
# CHECK-NEXT:              %extracted_slice_7 = tensor.extract_slice %arg10[%arg9, 0] [1, 16] [1, 1] : tensor<2x16xf32> to tensor<1x16xf32>
# CHECK-NEXT:              %7 = vector.transfer_read %extracted_slice_6[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x1xf32>, vector<1x1xf32>
# CHECK-NEXT:              %8 = vector.transfer_read %extracted_slice_3[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:              %9 = vector.transfer_read %extracted_slice_7[%c0, %c0], %0 {in_bounds = [true, true]} : tensor<1x16xf32>, vector<1x16xf32>
# CHECK-NEXT:              %10 = vector.contract {indexing_maps = [#map, #map1, #map2], iterator_types = ["parallel", "parallel", "reduction"], kind = #vector.kind<add>} %7, %8, %9 : vector<1x1xf32>, vector<1x16xf32> into vector<1x16xf32>
# CHECK-NEXT:              %11 = vector.transfer_write %10, %extracted_slice_7[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, tensor<1x16xf32>
# CHECK-NEXT:              %inserted_slice_8 = tensor.insert_slice %11 into %arg10[%arg9, 0] [1, 16] [1, 1] : tensor<1x16xf32> into tensor<2x16xf32>
# CHECK-NEXT:              scf.yield %inserted_slice_8 : tensor<2x16xf32>
# CHECK-NEXT:            } {"./i1"}
# CHECK-NEXT:            %inserted_slice_5 = tensor.insert_slice %6 into %arg8[0, %arg7] [2, 16] [1, 1] : tensor<2x16xf32> into tensor<2x32xf32>
# CHECK-NEXT:            scf.yield %inserted_slice_5 : tensor<2x32xf32>
# CHECK-NEXT:          } {"./j"}
...
# CHECK-NEXT:            %5 = vector.transfer_read %subview_8[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
...
# CHECK-NEXT:            %7 = vector.transfer_read %subview_9[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x16xf32, strided<[32, 1], offset: ?>>, vector<1x16xf32>
...
# CHECK-NEXT:            vector.transfer_write %13, %subview_9[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, memref<1x16xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:            %14 = arith.muli %c1, %c1_11 : index
# CHECK-NEXT:            %15 = arith.addi %c0, %14 : index
# CHECK-NEXT:            %subview_12 = memref.subview %subview_2[%15, 0] [1, 1] [1, 1] : memref<2x1xf32, strided<[512, 1], offset: ?>> to memref<1x1xf32, strided<[512, 1], offset: ?>>
# CHECK-NEXT:            %subview_13 = memref.subview %subview_6[%15, 0] [1, 16] [1, 1] : memref<2x16xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:            %16 = vector.transfer_read %subview_12[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
# CHECK-NEXT:            %17 = vector.transfer_read %subview_5[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x16xf32, strided<[32, 1], offset: ?>>, vector<1x16xf32>
# CHECK-NEXT:            %18 = vector.transfer_read %subview_13[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x16xf32, strided<[32, 1], offset: ?>>, vector<1x16xf32>
# CHECK-NEXT:            %19 = vector.extract %17[0] : vector<16xf32> from vector<1x16xf32>
# CHECK-NEXT:            %20 = vector.extract %16[0, 0] : f32 from vector<1x1xf32>
# CHECK-NEXT:            %21 = vector.broadcast %20 : f32 to vector<16xf32>
# CHECK-NEXT:            %22 = vector.extract %18[0] : vector<16xf32> from vector<1x16xf32>
# CHECK-NEXT:            %23 = vector.fma %21, %19, %22 : vector<16xf32>
# CHECK-NEXT:            %24 = vector.insert %23, %cst [0] : vector<16xf32> into vector<1x16xf32>
# CHECK-NEXT:            vector.transfer_write %24, %subview_13[%c0, %c0] {in_bounds = [true, true]} : vector<1x16xf32>, memref<1x16xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:            %subview_14 = memref.subview %subview_6[%15, 0] [1, 16] [1, 1] : memref<2x16xf32, strided<[32, 1], offset: ?>> to memref<1x16xf32, strided<[32, 1], offset: ?>>
