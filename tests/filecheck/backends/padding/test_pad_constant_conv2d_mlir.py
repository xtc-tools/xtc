...
with O.graph(name="pad_conv2d_nhwc_mini") as gb:
    p = O.pad2d(a, padding=2, axes=(1, 2), constant_value=3, name="pad")
...
# CHECK-NEXT:                      %2 = arith.mulf %in, %in_40 fastmath<fast> : f32
...
# CHECK-NEXT:    nodes:
# CHECK-NEXT:    - %2: pad2d(%0, padding={1: (2, 2), 2: (2, 2)}, constant_value=3) {name = 'pad'} : [1x8x8x3xfloat32] -> [1x12x12x3xfloat32]
