...
// CHECK-NEXT:      transform.annotate %loops "__node0__/J" : !transform.any_op
...
// CHECK-NEXT:      %3 = transform.get_parent_op %forall_op {isolated_from_above} : (!transform.any_op) -> !transform.any_op
