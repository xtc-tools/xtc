...
// CHECK-NEXT:  	vmovups 0x8e0(%rcx,%r9,4),%ymm0
// CHECK-NEXT:  	vmovups 0x8c0(%rcx,%r9,4),%ymm1
// CHECK-NEXT:  	vmovups 0x8a0(%rcx,%r9,4),%ymm2
// CHECK-NEXT:  	vmovups 0x880(%rcx,%r9,4),%ymm3
// CHECK-NEXT:  	vmovups 0x800(%rcx,%r9,4),%ymm4
// CHECK-NEXT:  	vmovups 0x820(%rcx,%r9,4),%ymm5
// CHECK-NEXT:  	vmovups 0x840(%rcx,%r9,4),%ymm6
// CHECK-NEXT:  	vmovups 0x860(%rcx,%r9,4),%ymm7
...
// CHECK-NEXT:  	vmovups %ymm4,0x800(%rcx,%r9,4)
// CHECK-NEXT:  	vmovups %ymm5,0x820(%rcx,%r9,4)
// CHECK-NEXT:  	vmovups %ymm6,0x840(%rcx,%r9,4)
// CHECK-NEXT:  	vmovups %ymm7,0x860(%rcx,%r9,4)
// CHECK-NEXT:  	vmovups %ymm3,0x880(%rcx,%r9,4)
// CHECK-NEXT:  	vmovups %ymm2,0x8a0(%rcx,%r9,4)
// CHECK-NEXT:  	vmovups %ymm1,0x8c0(%rcx,%r9,4)
// CHECK-NEXT:  	vmovups %ymm0,0x8e0(%rcx,%r9,4)
// CHECK-NEXT:  	add    $0x100,%r8
// CHECK-NEXT:  	cmp    $0xc0,%r9
// CHECK-NEXT:  	lea    0x40(%r9),%r9
// CHECK-NEXT:  	jb     <myfun+0xd0>
// CHECK-NEXT:  	add    $0x800,%rdi
// CHECK-NEXT:  	cmp    $0xff,%rax
// CHECK-NEXT:  	lea    0x1(%rax),%rax
// CHECK-NEXT:  	jb     <myfun+0xc0>
