...
# CHECK-NEXT:  [MlirNodeSchedule(node_name='%2_fill', node_ident='__xtc_id_%2_fill_', dims=['i', 'j'], loop_stamps=[], splits={}, tiles={'i': {'i': 1}, 'j': {'j': 1}}, permutation={'.': ['i', 'j']}, vectorization=[], parallelization=[], unrolling={}), MlirNodeSchedule(node_name='%2_reduce', node_ident='__xtc_id_%2_reduce_', dims=['i', 'j', 'k'], loop_stamps=[], splits={}, tiles={'i': {'i': 1, 'i1': 1}, 'j': {'j': 32, 'j1': 1}, 'k': {'k': 1, 'k1': 1}}, permutation={'%2_reduce': ['i', 'j', 'k', 'k1', 'i1', 'j1']}, vectorization=['j1'], parallelization=[], unrolling={'j1': 32, 'i1': 1, 'k1': 1})]
