...
// CHECK-NEXT:      linalg.matmul {__id1__, loop.dims = {i = 256 : i64, j = 256 : i64, k = 512 : i64}, loop.unroll = {k = 8 : i64}} ins(%arg0, %arg1 : memref<256x512xf32>, memref<512x256xf32>) outs(%arg2 : memref<256x256xf32>)
// CHECK-NEXT:      return
// CHECK-NEXT:    }
