...
# CHECK-NEXT:     %tiled_linalg_op_2, %loops_3 = transform.structured.tile_using_for %tiled_op tile_sizes [0, 32, 0] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
...
# CHECK-NEXT:       scf.for %arg4 = %c0 to %c32 step %c32 {
# CHECK-NEXT:         %subview_3 = memref.subview %subview_1[0, %arg4] [512, 32] [1, 1] : memref<512x32xf32, strided<[32, 1]>> to memref<512x32xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:         %subview_4 = memref.subview %subview_2[0, %arg4] [8, 32] [1, 1] : memref<8x32xf32, strided<[32, 1], offset: ?>> to memref<8x32xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:                       %2 = vector.transfer_read %subview_19[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
# CHECK-NEXT:                       %3 = vector.transfer_read %subview_17[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x2xf32, strided<[32, 1], offset: ?>>, vector<1x2xf32>
# CHECK-NEXT:                       %4 = vector.transfer_read %subview_20[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x2xf32, strided<[32, 1], offset: ?>>, vector<1x2xf32>
# CHECK-NEXT:                       %5 = vector.extract %3[0] : vector<2xf32> from vector<1x2xf32>
# CHECK-NEXT:                       %6 = vector.extract %2[0, 0] : f32 from vector<1x1xf32>
# CHECK-NEXT:                       %7 = vector.broadcast %6 : f32 to vector<2xf32>
# CHECK-NEXT:                       %8 = vector.extract %4[0] : vector<2xf32> from vector<1x2xf32>
# CHECK-NEXT:                       %9 = vector.fma %7, %5, %8 : vector<2xf32>
# CHECK-NEXT:                       %10 = vector.insert %9, %cst [0] : vector<2xf32> into vector<1x2xf32>
# CHECK-NEXT:                       vector.transfer_write %10, %subview_20[%c0, %c0] {in_bounds = [true, true]} : vector<1x2xf32>, memref<1x2xf32, strided<[32, 1], offset: ?>>
...
# CHECK-NEXT:                       %11 = vector.transfer_read %subview_21[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
# CHECK-NEXT:                       %12 = vector.transfer_read %subview_17[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x2xf32, strided<[32, 1], offset: ?>>, vector<1x2xf32>
# CHECK-NEXT:                       %13 = vector.transfer_read %subview_22[%c0, %c0], %0 {in_bounds = [true, true]} : memref<1x2xf32, strided<[32, 1], offset: ?>>, vector<1x2xf32>
# CHECK-NEXT:                       %14 = vector.extract %12[0] : vector<2xf32> from vector<1x2xf32>
# CHECK-NEXT:                       %15 = vector.extract %11[0, 0] : f32 from vector<1x1xf32>
# CHECK-NEXT:                       %16 = vector.broadcast %15 : f32 to vector<2xf32>
# CHECK-NEXT:                       %17 = vector.extract %13[0] : vector<2xf32> from vector<1x2xf32>
# CHECK-NEXT:                       %18 = vector.fma %16, %14, %17 : vector<2xf32>
# CHECK-NEXT:                       %19 = vector.insert %18, %cst [0] : vector<2xf32> into vector<1x2xf32>
# CHECK-NEXT:                       vector.transfer_write %19, %subview_22[%c0, %c0] {in_bounds = [true, true]} : vector<1x2xf32>, memref<1x2xf32, strided<[32, 1], offset: ?>>
# CHECK-NEXT:                     } {"./j1"}
# CHECK-NEXT:                   } {"./k1"}
# CHECK-NEXT:                 } {"./i1"}
# CHECK-NEXT:               } {"./j0"}
