...
comp = impl.get_compiler(
    shared_lib=True,
    dump_file="matmul_descript_slice_first_smaller",
...
# CHECK-NEXT:          %subview_5 = memref.subview %subview[0, 0] [18, 32] [1, 1] : memref<50x32xf32, strided<[64, 1], offset: ?>> to memref<18x32xf32, strided<[64, 1], offset: ?>>
# CHECK-NEXT:          %subview_6 = memref.subview %subview_4[0, 0] [18, 16] [1, 1] : memref<50x16xf32, strided<[64, 1], offset: ?>> to memref<18x16xf32, strided<[64, 1], offset: ?>>
# CHECK-NEXT:          scf.for %arg5 = %c0 to %c18 step %c18 {
# CHECK-NEXT:            %subview_9 = memref.subview %subview_5[%arg5, 0] [18, 32] [1, 1] : memref<18x32xf32, strided<[64, 1], offset: ?>> to memref<18x32xf32, strided<[64, 1], offset: ?>>
# CHECK-NEXT:            %subview_10 = memref.subview %subview_6[%arg5, 0] [18, 16] [1, 1] : memref<18x16xf32, strided<[64, 1], offset: ?>> to memref<18x16xf32, strided<[64, 1], offset: ?>>
...
# CHECK-NEXT:            } {"C/i[0]/i0"}
# CHECK-NEXT:          } {"C/i[0]/i"}
# CHECK-NEXT:          %subview_7 = memref.subview %subview[18, 0] [32, 32] [1, 1] : memref<50x32xf32, strided<[64, 1], offset: ?>> to memref<32x32xf32, strided<[64, 1], offset: ?>>
# CHECK-NEXT:          %subview_8 = memref.subview %subview_4[18, 0] [32, 16] [1, 1] : memref<50x16xf32, strided<[64, 1], offset: ?>> to memref<32x16xf32, strided<[64, 1], offset: ?>>
# CHECK-NEXT:          scf.for %arg5 = %c0 to %c32 step %c32 {
# CHECK-NEXT:            %subview_9 = memref.subview %subview_7[%arg5, 0] [32, 32] [1, 1] : memref<32x32xf32, strided<[64, 1], offset: ?>> to memref<32x32xf32, strided<[64, 1], offset: ?>>
# CHECK-NEXT:            %subview_10 = memref.subview %subview_8[%arg5, 0] [32, 16] [1, 1] : memref<32x16xf32, strided<[64, 1], offset: ?>> to memref<32x16xf32, strided<[64, 1], offset: ?>>
