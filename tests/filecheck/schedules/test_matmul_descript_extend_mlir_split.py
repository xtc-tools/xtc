...
#CHECK-NEXT:     %tiled_linalg_op_8, %loops_9 = transform.structured.tile_using_for %first tile_sizes [1, 0, 0] : (!transform.any_op) -> (!transform.any_op, !transform.any_op)
...
#CHECK-NEXT:             %0 = vector.transfer_read %subview_11[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
#CHECK-NEXT:             %1 = vector.transfer_read %subview_5[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %2 = vector.transfer_read %subview_12[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %3 = vector.extract %1[0] : vector<4xf32> from vector<1x4xf32>
#CHECK-NEXT:             %4 = vector.extract %0[0, 0] : f32 from vector<1x1xf32>
#CHECK-NEXT:             %5 = vector.broadcast %4 : f32 to vector<4xf32>
#CHECK-NEXT:             %6 = vector.extract %2[0] : vector<4xf32> from vector<1x4xf32>
#CHECK-NEXT:             %7 = vector.fma %5, %3, %6 : vector<4xf32>
#CHECK-NEXT:             %8 = vector.insert %7, %cst [0] : vector<4xf32> into vector<1x4xf32>
#CHECK-NEXT:             vector.transfer_write %8, %subview_12[%c0, %c0] {in_bounds = [true, true]} : vector<1x4xf32>, memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %9 = arith.addi %arg6, %c1 : index
#CHECK-NEXT:             %subview_13 = memref.subview %subview_7[%9, 0] [1, 1] [1, 1] : memref<4x1xf32, strided<[512, 1], offset: ?>> to memref<1x1xf32, strided<[512, 1], offset: ?>>
#CHECK-NEXT:             %subview_14 = memref.subview %subview_8[%9, 0] [1, 4] [1, 1] : memref<4x4xf32, strided<[32, 1], offset: ?>> to memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %10 = vector.transfer_read %subview_13[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
#CHECK-NEXT:             %11 = vector.transfer_read %subview_5[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %12 = vector.transfer_read %subview_14[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
...
#CHECK-NEXT:             vector.transfer_write %18, %subview_14[%c0, %c0] {in_bounds = [true, true]} : vector<1x4xf32>, memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:           } {"C/i[0]/i0"}
...
#CHECK-NEXT:             vector.transfer_write %8, %subview_12[%c0, %c0] {in_bounds = [true, true]} : vector<1x4xf32>, memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %9 = arith.addi %arg6, %c1 : index
#CHECK-NEXT:             %subview_13 = memref.subview %subview_9[%9, 0] [1, 1] [1, 1] : memref<12x1xf32, strided<[512, 1], offset: ?>> to memref<1x1xf32, strided<[512, 1], offset: ?>>
#CHECK-NEXT:             %subview_14 = memref.subview %subview_10[%9, 0] [1, 4] [1, 1] : memref<12x4xf32, strided<[32, 1], offset: ?>> to memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %10 = vector.transfer_read %subview_13[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
#CHECK-NEXT:             %11 = vector.transfer_read %subview_5[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %12 = vector.transfer_read %subview_14[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %13 = vector.extract %11[0] : vector<4xf32> from vector<1x4xf32>
...
#CHECK-NEXT:             %18 = vector.insert %17, %cst [0] : vector<4xf32> into vector<1x4xf32>
#CHECK-NEXT:             vector.transfer_write %18, %subview_14[%c0, %c0] {in_bounds = [true, true]} : vector<1x4xf32>, memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %19 = arith.addi %arg6, %c2 : index
#CHECK-NEXT:             %subview_15 = memref.subview %subview_9[%19, 0] [1, 1] [1, 1] : memref<12x1xf32, strided<[512, 1], offset: ?>> to memref<1x1xf32, strided<[512, 1], offset: ?>>
#CHECK-NEXT:             %subview_16 = memref.subview %subview_10[%19, 0] [1, 4] [1, 1] : memref<12x4xf32, strided<[32, 1], offset: ?>> to memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %20 = vector.transfer_read %subview_15[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
#CHECK-NEXT:             %21 = vector.transfer_read %subview_5[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %22 = vector.transfer_read %subview_16[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %23 = vector.extract %21[0] : vector<4xf32> from vector<1x4xf32>
#CHECK-NEXT:             %24 = vector.extract %20[0, 0] : f32 from vector<1x1xf32>
#CHECK-NEXT:             %25 = vector.broadcast %24 : f32 to vector<4xf32>
#CHECK-NEXT:             %26 = vector.extract %22[0] : vector<4xf32> from vector<1x4xf32>
#CHECK-NEXT:             %27 = vector.fma %25, %23, %26 : vector<4xf32>
#CHECK-NEXT:             %28 = vector.insert %27, %cst [0] : vector<4xf32> into vector<1x4xf32>
#CHECK-NEXT:             vector.transfer_write %28, %subview_16[%c0, %c0] {in_bounds = [true, true]} : vector<1x4xf32>, memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %29 = arith.addi %arg6, %c3 : index
#CHECK-NEXT:             %subview_17 = memref.subview %subview_9[%29, 0] [1, 1] [1, 1] : memref<12x1xf32, strided<[512, 1], offset: ?>> to memref<1x1xf32, strided<[512, 1], offset: ?>>
#CHECK-NEXT:             %subview_18 = memref.subview %subview_10[%29, 0] [1, 4] [1, 1] : memref<12x4xf32, strided<[32, 1], offset: ?>> to memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:             %30 = vector.transfer_read %subview_17[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x1xf32, strided<[512, 1], offset: ?>>, vector<1x1xf32>
#CHECK-NEXT:             %31 = vector.transfer_read %subview_5[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %32 = vector.transfer_read %subview_18[%c0, %c0], %cst_0 {in_bounds = [true, true]} : memref<1x4xf32, strided<[32, 1], offset: ?>>, vector<1x4xf32>
#CHECK-NEXT:             %33 = vector.extract %31[0] : vector<4xf32> from vector<1x4xf32>
#CHECK-NEXT:             %34 = vector.extract %30[0, 0] : f32 from vector<1x1xf32>
#CHECK-NEXT:             %35 = vector.broadcast %34 : f32 to vector<4xf32>
#CHECK-NEXT:             %36 = vector.extract %32[0] : vector<4xf32> from vector<1x4xf32>
#CHECK-NEXT:             %37 = vector.fma %35, %33, %36 : vector<4xf32>
#CHECK-NEXT:             %38 = vector.insert %37, %cst [0] : vector<4xf32> into vector<1x4xf32>
#CHECK-NEXT:             vector.transfer_write %38, %subview_18[%c0, %c0] {in_bounds = [true, true]} : vector<1x4xf32>, memref<1x4xf32, strided<[32, 1], offset: ?>>
#CHECK-NEXT:           } {"C/i[1]/i0"}
#CHECK-NEXT:         } {"C/j0"}
#CHECK-NEXT:       } {"C/k"}
#CHECK-NEXT:     } {"C/j"}
